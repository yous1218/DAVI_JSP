...
public class MailSend {
	...
	public static void naverMailSend(String email, String docking, String path) { 
		...
		try { 
			...
			// 메일 내용 
			message.setContent( 
				"<a href=\"" + path + "/member/changePw.me?docking="+docking+"&email="+email+"\">비밀번호 변경 페이지</a>",
	...
	public static void gmailSend(String id, String email, String docking, String path) {
		...
		// 메일 내용
		msg.setContent("<a href=\"" + path + "/member/changePw.me?memberId=" + id + "&docking="+docking+"&email="+email+"\">비밀번호 변경 페이지</a>",
				"text/html; charset=utf-8");
