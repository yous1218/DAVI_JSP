									...
									<div class="table-wrapper mainFrame">
												...
												<c:when test="${CheatBoardList != null and fn:length(CheatBoardList) > 0 }">
													<c:forEach var="cheatBoardVO" items="${CheatBoardList}">
														<tr>
															...
															<td id="title"><a href="${pageContext.request.contextPath}/board/cheatViewOk.bo?cheatNum=${cheatBoardVO.getCheatNum()}&page=${nowPage}&searchWord=${param.searchWord}" class="aboard">${cheatBoardVO.getCheatTitle()}</a></td>													
										...
										<c:if test="${not empty sessionScope.session_id}">	
											<div style="text-align: right; margin-top:4%;">
												<a href="${pageContext.request.contextPath}/app/board/cheatBoardWrite.jsp?page=${nowPage}&searchWord=${param.searchWord}" 
