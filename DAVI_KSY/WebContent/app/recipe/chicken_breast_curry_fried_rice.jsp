		...
		<div id="main">
			<div class="inner">
				...
				<div style="display:flex; justify-content:space-between; align-items:center;margin:3% auto; padding:0 10%;">
					...
					<div style="width:40%;">
						<!-- 식단 이미지  -->
						<img alt="" src="${pageContext.request.contextPath}/app/recipe/img/chicken_breast_curry_fried_rice.png" style="max-width:100%; height:auto;">
					</div>
				</div>
				...
				<div style="display:flex; justify-content:space-between; margin:0 auto; padding:0 10%;">
					<div style="margin-right:6%;">
						...
						<ul class="material" style="list-style-type:square;">
							...
							<li>양파 1/2개</li>
							<li>밥 2공기</li>
							<li>양념:카레가루 25g,<br>소금 약간,후추 약간</li>
						</ul>
					</div>
					<div style="width:50%">
						...
						<ol>
							<!-- 재료 하나씩 li에 작성 -->
							<li  class="recipe">먼저 야채를 썰어서 준비해 줍니다.</li>
							<li  class="recipe">프라이팬에 기름을 두르고 파 기름을 만들어 줍니다.</li>
							<li  class="recipe">파 기름을 만든 후에 나머지 야채를 다 넣고 볶아줍니다.</li>
							<li  class="recipe">야채를 다 볶으면 닭 가슴살을 넣어주고 소금 후추로 살짝 간을 해줍니다.</li>
							<li  class="recipe">그다음 카레 가르와 밥을 넣고 골고루 볶아줍니다.</li>
						</ol>
					</div>
				</div>
