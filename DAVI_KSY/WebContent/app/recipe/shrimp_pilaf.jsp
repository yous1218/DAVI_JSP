		...
		<div id="main">
			<div class="inner">
				...
				<div style="display:flex; justify-content:space-between; align-items:center;margin:3% auto; padding:0 10%;">
					...
					<div style="width:40%;">
						<img alt="" src="${pageContext.request.contextPath}/app/recipe/img/shrimp_pilaf.png" style="max-width:100%; height:auto;">
					</div>
				</div>
				...
				<div style="display:flex; justify-content:space-between; margin:0 auto; padding:0 10%;">
					...
					<div style="width:50%">
						...
						<ol>
							<li class="recipe"> 양파와 대파를 썰어줍니다.</li>
							<li  class="recipe"> 애호박은 십자썰기를 해줍니다.</li>
							<li  class="recipe"> 풋고추는 미리 물에 깨끗이 씻어주고 속을 정리하고 양파와 비슷한 크기로 썰어줍니다.</li>
							<li  class="recipe"> 팬에 기름을 조금 두르고 대파와 마늘을 넣고 볶아줍니다.</li>
							<li  class="recipe"> 마늘과 파의 향이 올라오고 색이 변하기 시작하면 양파를 넣고 같이 볶아줍니다.</li>
							<li  class="recipe"> 양파의 색이 투명해질 때쯤, 호박과 고추를 넣고 같이 볶아줍니다.</li>
							<li  class="recipe"> 밥을 한쪽 면으로 밀어주신 뒤 팬의 바닥면에 간장 1 큰 술을 넣고 간장을 살짝 태워줍니다.</li>
							<li  class="recipe"> 올리고당 1 큰 술을 넣고 볶아주시면 완성입니다.</li>
						</ol>
					</div>
				</div>
