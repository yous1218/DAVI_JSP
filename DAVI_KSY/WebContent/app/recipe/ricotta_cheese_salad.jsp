			...
			<div class="inner">
				...
				<div style="display:flex; justify-content:space-between; align-items:center;margin:3% auto; padding:0 10%;">
					<div style="width:40%; margin-right:6%;">
						...
						치즈는 풍부함 칼슘 그리고 오래 유지되는 포만감 때문에 적게 먹는다면 다이어트에 유용합니다. 
						</h3>
					</div>
					<div style="width:40%;">
						<!-- 식단 이미지  -->
						<img alt="" src="${pageContext.request.contextPath}/app/recipe/img/ricotta_cheese_salad.png" style="max-width:100%; height:auto;">
					</div>
				</div>
				...
				<div style="display:flex; justify-content:space-between; margin:0 auto; padding:0 10%;">
					...
					<div style="width:50%">
						...
						<ol>
							...
							<li  class="recipe">접시에 샐러드 채소를 담고 손질한 딸기와 오렌지 그리고 리코타치즈를 먹기 좋게 올려주세요.</li>
							<li  class="recipe">미리 만들어 놓은 발사믹 드레싱과 꿀을 뿌려 마무리해 주세요.</li>
						</ol>
					</div>
				</div>
